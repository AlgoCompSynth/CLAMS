...
take many months to duplicate in Forth. See [@smith2021rp2040, chapter 8]
...
available in the RP2040 and the SDK.
    ...
    *Most* of the CORE word set and some of the CORE EXT word sets will be
implemented, but a few tricky or risky words will be omitted. The
Search-Order word set will be implmented, and all of the RP2040 or SDK
specific words will be in specialized word sets.
    ...
    Custom word sets implemented:
        ...
        - SDK access as needed, for example:
            - WiFi, Bluetooth
            - USB other than serial
            - PicoVision-specific operations

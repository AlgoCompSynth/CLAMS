...
## What is CLAMS?
- Command Line Algorithmic Music Synthesizer
...
- GPIO pin: General Purpose Input-Output
    - a pin that can be configured for I/O
...
- Effects: echo, reverb, chorus, flanger, etc.
...
- Forth for the Electro-Smith Daisy Seed
    ...
    - Controller and synthesis both done in Forth
...
- Only DAC or I2S audio is practical in Forth
...
- I2S / DAC audio is supported on all boards
...
## Integrate C3 and AMY on Pico WH / audio expansion
- Essentially complete second concept
...
- This is really the sweet spot for CLAMS
    ...
    - May also test Bluetooth audio and MIDI
